...
public class TableClass {
	...
	protected static final String CREATE_USER_TAB_QUERY = "CREATE TABLE IF NOT EXISTS " + USER_TAB_NAME + "("
			...
			+ "password TEXT NOT NULL, " + "nickname TEXT NOT NULL, " + "schoolname TEXT NOT NULL" + ")";
	...
	protected static final String CREATE_PASS_TAB_QUERY = "CREATE TABLE IF NOT EXISTS " + PASS_TAB_NAME + "("
			...
			+ "passwordvalue TEXT NOT NULL, " + "u_id INTEGER NOT NULL, FOREIGN KEY(u_id) REFERENCES "
			+ USER_TAB_NAME + " ON DELETE CASCADE ON UPDATE CASCADE)";
